...
enum class Country(val countryName: String, val slug: String, val code: String) {
    ...
    BurkinaFaso(countryName = "Burkina Faso", slug = "burkina-faso", code = "BF"),
    CaboVerde(countryName = "Cabo Verde", slug = "cabo-verde", code = "CV"),
    ...
    DominicanRepublic(countryName = "Dominican Republic", slug = "dominican-republic", code = "DO"),
    Ecuador(countryName = "Ecuador", slug = "ecuador", code = "EC"),
    Egypt(countryName = "Egypt", slug = "egypt", code = "EG"),
    ElSalvador(countryName = "El Salvador", slug = "el-salvador", code = "SV"),
    EquatorialGuinea(countryName = "Equatorial Guinea", slug = "equatorial-guinea", code = "GQ"),
    ...
    GuineaBissau(countryName = "Guinea-Bissau", slug = "guinea-bissau", code = "GW"),
    ...
    KoreaSouth(countryName = "Korea, South", slug = "korea--south", code = "KR"),
    ...
    NewZealand(countryName = "New Zealand", slug = "new-zealand", code = "NZ"),
    ...
    NorthMacedonia(countryName = "North Macedonia", slug = "north-macedonia", code = "MK"),
    ...
    PapuaNewGuinea(countryName = "Papua New Guinea", slug = "papua-new-guinea", code = "PG"),
    ...
    SouthAfrica(countryName = "South Africa", slug = "south-africa", code = "ZA"),
    Spain(countryName = "Spain", slug = "spain", code = "ES"),
    SriLanka(countryName = "Sri Lanka", slug = "sri-lanka", code = "LK"),
